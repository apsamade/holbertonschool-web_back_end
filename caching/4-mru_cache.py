...
This module defines a MRUCache class, a caching system that follows the
MRU (Most Recently Used) eviction policy when the cache is full.
"""
...
class MRUCache(BaseCaching):
    ...
    When the cache exceeds BaseCaching.MAX_ITEMS items, the most recently
    ...
    def put(self, key, item):
        ...
        the cache exceed BaseCaching.MAX_ITEMS, the most recently used item
